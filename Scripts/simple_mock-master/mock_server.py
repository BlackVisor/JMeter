...
relay = 0
#转发服务器地址
host1 = 'http://192.168.3.100:5202'


def getconfig():
    cf = ConfigParser.ConfigParser()
    path = '/Users/chenwenkun/Desktop/mock_server/simple_mock-master/db.config'
    cf.read(path)
...
if __name__ == '__main__':
    app.run(host='192.168.3.100',debug=True, port=5201,threaded=True)
